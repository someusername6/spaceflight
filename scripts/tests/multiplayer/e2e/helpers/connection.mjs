...
import { injectTestConfig, TIMEOUTS } from '../core/config.mjs';
import { VITE_URL } from '../core/servers.mjs';
...
export async function setupHostAndGuest(browser) {
  ...
  // Wait for the "joined" system message on host - confirms WebRTC data channel is active
  await hostPage.waitForFunction(
    () => {
