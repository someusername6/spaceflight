 ...
 */
export async function testFullHostFlow() {
  console.log('\n=== Test: Full Host Flow ===\n');
  ...
  try {
    ...
    console.log('\n✅ Full host flow test PASSED\n');
    await context.close();
    return true;
  } catch (error) {
    console.error('\n❌ Full host flow test FAILED:', error.message, '\n');
    return false;
  } finally {
    await browser.close();
  }
 ...
 */
export async function testHostAndGuestConnection() {
  console.log('\n=== Test: Host and Guest Connection ===\n');
  ...
  try {
    ...
    console.log('\n✅ Host and guest connection test PASSED\n');
    ...
    console.error(
      '\n❌ Host and guest connection test FAILED:',
      error.message,
      '\n',
    );
    return false;
