...
test('Lock does not accumulate when target is outside missile range', () => {
...
test('Lock accumulates when target is inside missile range', () => {
...
test('Lock is lost immediately when target moves out of range', () => {
...
test('Full lock is lost immediately when target moves out of range', () => {
  // Start with target in range
  const { world, targetTransform, secondaryWeapons } = createTestSetup(1000);
...
test('Lock resumes when target moves back in range', () => {
...
test('Lock works at exact missile range boundary', () => {
...
test('Lock is lost just outside missile range boundary', () => {
