/**
 * Ambush Mission File Updater
 *
 * Uses ts-morph to update ambush mission reward values in source files.
...
/**
 * Update ambush mission rewards in a TypeScript file
 *
 ...
 */
export function updateAmbushFile(project, filePath, rewardMap) {
