...
// ============================================================
// Speed Compatibility Tests (Lead Indicator Distance)
// ============================================================

test('Linked mode when projectiles have similar speeds', () => {
...
test('Single mode when projectile speeds are incompatible', () => {
...
test('Single mode when mixing slow and medium speed projectiles', () => {
...
test('Linked mode when projectile speeds are within 30% threshold', () => {
...
test('Beams are ignored in projectile speed compatibility check', () => {
