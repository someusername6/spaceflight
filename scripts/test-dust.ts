 ...
 * Run with: npx ts-node scripts/test-dust.ts
 */

// Current dust configuration
...
function spawnParticle(spawnCenterZ: number): Particle {
...
function isInViewCone(p: Particle, playerZ: number): boolean {
